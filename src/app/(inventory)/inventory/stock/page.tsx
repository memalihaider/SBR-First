      ...
      <div className="flex items-center justify-between">
        ...
        <Dialog open={isAdjustDialogOpen} onOpenChange={setIsAdjustDialogOpen}>
          <DialogTrigger asChild>
            <Button className="bg-blue-600 hover:bg-blue-700 text-white" onClick={() => setIsAdjustDialogOpen(true)}>
          ...
          <div className="flex flex-col md:flex-row gap-4">
            ...
            <div className="flex gap-2">
              <Button
                ...
                className={filterStatus === 'all' ? 'bg-blue-600 hover:bg-blue-700 text-white' : 'bg-white border-gray-300 hover:bg-gray-50'}
              >
                All Products
              </Button>
              <Button
                ...
                className={filterStatus === 'low' ? 'bg-blue-600 hover:bg-blue-700 text-white' : 'bg-white border-gray-300 hover:bg-gray-50'}
              >
                Low Stock
              </Button>
              <Button
                ...
                className={filterStatus === 'out' ? 'bg-blue-600 hover:bg-blue-700 text-white' : 'bg-white border-gray-300 hover:bg-gray-50'}
              >
                Out of Stock
              </Button>
            </div>
