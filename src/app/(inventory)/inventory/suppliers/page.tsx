          ...
          <div className="flex flex-col md:flex-row gap-4">
            ...
            <div className="flex gap-2">
              ...
              <Button
                ...
                className={filterStatus === 'active' ? 'bg-blue-600 hover:bg-blue-700 text-white' : 'bg-white border-gray-300 hover:bg-gray-50'}
              >
                Active
              </Button>
              <Button
                ...
                className={filterStatus === 'inactive' ? 'bg-blue-600 hover:bg-blue-700 text-white' : 'bg-white border-gray-300 hover:bg-gray-50'}
              >
                Inactive
              </Button>
            </div>
