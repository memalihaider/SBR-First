      ...
      <Card className="shadow-lg">
        <CardHeader className="bg-linear-to-r from-gray-50 to-gray-100 rounded-t-lg">
          <div className="flex flex-col sm:flex-row justify-between items-start sm:items-center gap-4">
            ...
            <Button className=" bg-purple-600 text-white shadow-md" onClick={() => setIsAddEmployeeOpen(true)}>
                    ...
                    <td className="px-6 py-4 whitespace-nowrap">
                      <div className="flex items-center">
                        <div className="shrink-0 h-10 w-10">
                          <div className="h-10 w-10 rounded-full bg-linear-to-br bg-purple-600 flex items-center justify-center">
      ...
      <Dialog open={isAddEmployeeOpen} onOpenChange={setIsAddEmployeeOpen}>
        <DialogContent className="max-w-2xl bg-white border-2 border-gray-200 shadow-2xl">
          ...
          <DialogFooter>
            ...
            <Button onClick={handleAddEmployee} className="bg-purple-600 text-white">
              Add Team Member
            </Button>
          </DialogFooter>
        </DialogContent>
