...
export default function PayrollPage() {
  ...
  const handleStatusChange = async (staffId: string, newStatus: 'paid' | 'pending' | 'processed') => {
    try {
      ...
      <div className="bg-linear-to-r from-red-600 to-red-700 rounded-xl p-6 shadow-lg">
        <div className="flex justify-between items-center">
          ...
          <div className="flex gap-3">
            <Button 
              className="bg-white text-red-600 hover:bg-red-50 border-2 border-red-300"
              onClick={loadData}
              disabled={loading}
            >
          ...
          <div className="bg-gray-50 p-4 border-t">
            <div className="flex justify-between items-center">
              <div className="text-sm text-gray-600">
                Showing {managers.length} managers and {employees.filter(emp => emp.status === 'active').length} employees
              </div>
              <div className="flex items-center space-x-4">
                ...
                <div className="text-sm font-semibold text-gray-900">
                  Total Monthly Payroll: <span className="text-red-600">${stats.totalMonthlySalary.toLocaleString()}</span>
                </div>
              </div>
            </div>
          </div>
